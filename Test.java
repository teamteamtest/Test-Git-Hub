...
public class PageHandler {
	...
	public static final int PAGE_GROUP_SIZE = 2;
	...
	//특정 페이지의 선택 바에 표시될 시작 페이지 번호를 구해주는 기능
	public static int getStartPageNumber(int pageNumber){
		return (pageNumber - 1)/PAGE_GROUP_SIZE * PAGE_LIST_SIZE +1;
		
	}
	//특정 페이지의 선택 바에 표시될 끝 페이지 번호를 구해주는 기능
